...
### Forbearance Lending as a Crisis Management Tool: Evidence from Japan (*with [Isabelle Roland](https://www.isabelleroland.com) and Yukiko Saito*)
...
### Structural determinants of credit market tightness and the zombie firm share (*with [Masashige Hamano](https://sites.google.com/site/masashigehamano/masashige-hamano-lab), [Mototsugu Shintani](https://sites.google.com/site/motoshintani/), Iichiro Uesugi, and Francesco Zanetti*)
...
### Bouncing back: how mothballing curbs prices (*with [Thibaut Duprey](https://sites.google.com/site/thibautduprey/), Daniel E. Rigobon, and Artur Kotlicki*)
...
### Blockwise Boosted Inflation: Non-linear determinants of inflation using machine learning (*with Marcus Buckmann and [Galina Potjagailo](https://sites.google.com/view/gpotjagailo/home)*)
...
### When the fog clears: the effect of reduced inflation uncertainty on households' financial behaviour (*with [Johannes J. Fischer](https://sites.google.com/view/johannesjfischer) and Christoph Herler*)
...
### Endogenous Separations and Non-monotone Beveridge Curve Shifts (*with [Hanbaek Lee](https://sites.google.com/view/hanbaeklee/home) and [Francesco Zanetti](https://users.ox.ac.uk/~wadh4073/)*)
...
### The Drivers of Household Inflation Uncertainty (*with Prachi Srivastava*)

### Hiring, Mismatch, and Vacancies: Lessons from Unique U.K. Vacancy Data (*with [Andrea Alati](https://andrealati.github.io), Tomas Key, Bradley Speigner, and Eran Yashiv*)
